...
#pragma warning restore 0618
        ...
        protected virtual void OnTriggerEnter(Collider collider)
        {
            ...
            if (colliderInteractableObject != null && colliderInteractableObject.tag == "knob")
            {
                
                Canvas canvas = colliderInteractableObject.GetComponentInChildren<Canvas>();
                canvas.enabled = true;
            }
        ...
        protected virtual void OnTriggerExit(Collider collider)
        {
            ...
            if (colliderInteractableObject != null && colliderInteractableObject.tag == "knob")
            {
                //Debug.Log(colliderInteractableObject.tag);
                Canvas canvas = colliderInteractableObject.GetComponentInChildren<Canvas>();
